...
test_unmapped_references_in_operator if {
	...
	lib.assert_equal_results(olm.deny, expected) with input.snapshot.components as [component1]
		...
		with data.rule_data as {"pipeline_intention": "release", "allowed_olm_image_registry_prefixes": ["registry.io"], "allowed_olm_resource_kinds": ["ClusterServiceVersion"]}
...
test_allowed_olm_resource_kind if {
    ...
    lib.assert_equal_results(olm.deny, expected_empty)
